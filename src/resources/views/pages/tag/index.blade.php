                        ...
                        <table class="table table-hover">
                            ...
                            @foreach($tags ?? [] as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('get.adm_blog.tag.delete', $item->id) }}" class="btn btn-sm btn-danger"><i class="fas fa-trash-alt"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
            ...
            <div class="col-sm-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('get.adm_blog.tag.store') }}" method="POST" autocomplete="off">
                            @csrf
                            <div class="mb-3">
